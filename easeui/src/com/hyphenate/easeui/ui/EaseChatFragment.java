...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
        ...
        chatRoomChangeListener = new EMChatRoomChangeListener() {
            ...
            public void onChatRoomDestroyed(String roomId, String roomName) {
                if (roomId.equals(toChatUsername)) {
                    ...
                    getActivity().finishActivityByAnimation(this);
                }
            }
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        for (EMMessage message : messages) {
            Log.e(TAG,"List<EMMessage> messages "+ message.getFrom());
            Log.e(TAG,"List<EMMessage> messages "+ message.getType());
            Log.e(TAG,"List<EMMessage> messages "+ message.getUserName());
...
//                startActivityForResult(new Intent(getActivity(), EaseBaiduMapActivity.class), REQUEST_CODE_MAP);
    ...
    protected void sendMessage(EMMessage message){
        Log.d(TAG, "sendMessage: " + chatFragmentHelper);
        if (message == null) {
            return;
        }
        if(chatFragmentHelper != null){
