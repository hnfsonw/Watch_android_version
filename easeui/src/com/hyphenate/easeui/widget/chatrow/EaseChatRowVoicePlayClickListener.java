...
public class EaseChatRowVoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		if (message.direct() == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(R.drawable.row4);
		} else {
			voiceIconView.setImageResource(R.drawable.my_row4);
		}
		// stop play voice
		if (mediaPlayer != null) {
			mediaPlayer.stop();
	...
	public void playVoice(String filePath) {
		...
		Log.e(TAG,EaseUI.getInstance().getSettingsProvider().isSpeakerOpened() + "isSpeakerOpened");
