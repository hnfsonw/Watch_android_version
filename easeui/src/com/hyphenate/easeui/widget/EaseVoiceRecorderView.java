    ...
    protected Handler micImageHandler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            micImage.setImageDrawable(micImages[msg.what]);
                ...
                Log.e("DevicesHomeActivity","音量显示异常 " +e.getMessage());
            }
        }
    };
    ...
    public boolean onPressToSpeakBtnTouch(View v, MotionEvent event, EaseVoiceRecorderCallback recorderCallback) {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            try {
                if (EaseChatRowVoicePlayClickListener.isPlaying){
                    Log.e("DevicesHomeActivity ","EaseChatRowVoicePlayClickListener.isPlaying");
                    EaseChatRowVoicePlayClickListener.currentPlayListener.stopPlayVoice();
                }
                mIntent.setAction("ACTION_DOWN");
                context.sendBroadcast(mIntent);
                v.setPressed(true);
                startRecording();
            } catch (Exception e) {
                v.setPressed(false);
                Log.e("DevicesHomeActivity","按下异常 ");
            }
            return true;
        ...
        case MotionEvent.ACTION_MOVE:
            try {
                ...
                Log.e("DevicesHomeActivity", "移动异常");
            }
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (event.getY() < 0) {
                ...
                Log.e("DevicesHomeActivity","停止记录和发送声音文件");
                    int length = stopRecoding();
                Log.e("DevicesHomeActivity","音频长度 " +length);
                    if (length > 0) {
                ...
                mIntent.setAction("ACTION_UP");
                context.sendBroadcast(mIntent);
            }
            catch (Exception e) {
            e.printStackTrace();
                Log.e("DevicesHomeActivity","松开异常 "+e.getMessage() + "~~~~~");
//                    Toast.makeText(context, R.string.send_failure_please, Toast.LENGTH_SHORT).show();
    ...
    public void discardRecording() {
        Log.e("DevicesHomeActivity","松开 丢弃" + Thread.currentThread().getName());
        if (wakeLock.isHeld()){
            wakeLock.release();
            Log.d("DevicesHomeActivity","wakeLock.isHeld()");
        }
        try {
            // stop recording
            if (voiceRecorder.isRecording()) {
                Log.e("DevicesHomeActivity ","停止记录");
                voiceRecorder.discardRecording();
                this.setVisibility(View.INVISIBLE);
            }
        } catch (Exception e) {
            Log.e("DevicesHomeActivity","丢弃异常 " + e.getMessage());
        }
    }
