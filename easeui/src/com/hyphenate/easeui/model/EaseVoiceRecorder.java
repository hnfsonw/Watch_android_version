...
public class EaseVoiceRecorder {
    ...
    public String startRecording(Context appContext) {
        Log.e("DevicesHomeActivity","开始记录到文件中");
        file = null;
        try {
            ...
            Log.e("DevicesHomeActivity ","prepare() failed " + e.toString());
        }
            ...
            public void run() {
                ...
                try {
                    while (isRecording) {
                        ...
                        Log.e("DevicesHomeActivity"," ~~isRecording");
                    ...
                    Log.e("DevicesHomeActivity",e.toString());
                }
            }
        }).start();
    ...
    public void discardRecording() {
                if (recorder != null) {
                    Log.d("DevicesHomeActivity","停止重新编码 recorder != null");
                    try {
                        recorder.stop();
                        recorder.release();
                        recorder = null;
                        ...
                        if (file != null && file.exists() && !file.isDirectory()) {
                            Log.e("DevicesHomeActivity","file  != null");
                            file.delete();
                        }
                        System.gc();
                    } catch (IllegalStateException e) {
                        Log.e("DevicesHomeActivity","停止重新编码 异常11" + e.getMessage());
                    } catch (RuntimeException e){
                        Log.e("DevicesHomeActivity","停止重新编码 异常22~~" + e.getMessage());
                    }
                    isRecording = false;
                }
