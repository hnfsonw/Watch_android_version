...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			// canvas.drawText(getResources().getString(R.string.AddDevice_ScanTips),
			// frame.left, (float) (frame.bottom + (float)TEXT_PADDING_TOP
			// *density), paint);

			paint.setColor(getResources().getColor(R.color.Color_Blue_Deep));
			paint.setTextSize(TEXT_SIZE * density);
			// paint.setAlpha(0x40);
			paint.setTypeface(Typeface.DEFAULT_BOLD);
			String text = getResources().getString(R.string.AddDevice_ScanTips);
