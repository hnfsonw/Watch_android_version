...
public class ParentsSchoolsFramgent extends BaseFragment implements AdapterView.OnItemClickListener, AbsListView.OnScrollListener, SpringView.OnFreshListener {
    ...
    public LoadingPager.LoadedResult initData(LoadingPager loadingPager) {
        ...
        if (mStoryBooksPresenter == null) {
            mStoryBooksPresenter = new StoryBooksPresenter(getContext(), this, "ParentsSchools");
        }
        try {

            mAlbums = mStoryBooksPresenter.loadData(mPage, "843");
    ...
    public View initSuccessView() {
        try {
            ...
            mTotalCount = (int) SharedPreferencesUtils.getParam(MyApplication.sInstance, "ParentsSchools_totalCount", 0);
            initListener();
            mPage++;
    ...
    public void onSuccess(List<Album> alba, int totalCount) {
        ...
        SharedPreferencesUtils.setParam(MyApplication.sInstance, "ParentsSchools_totalCount", mTotalCount);
        if (mAlbums == null) {
            //去更新fragmen UI
            mAlbums = alba;
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        if (scrollState == SCROLL_STATE_IDLE) {
            ...
            if (view.getLastVisiblePosition() > count && (mAlbums == null
                ...
                mStoryBooksPresenter.loadDataNet(mPage, "843");
    ...
    public void onResume() {
        ...
        MobclickAgent.onPageStart("ParentsSchoolsFramgent"); //统计页面，"MainScreen"为页面名称，可自定义
    }
