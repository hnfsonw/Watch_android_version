...
/**
 * 创 建 者: LoyBin
 * 创建时间: 2017/09/07 下午3:31
 * 描   述: 英语启蒙Framgent
 */
public class EnglishEnlightenmentFramgent extends BaseFragment implements AdapterView.OnItemClickListener, AbsListView.OnScrollListener, SpringView.OnFreshListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LogUtils.e("StoryBooksFramgent", "EnglishEnlightenmentFramgent  onCreate");
    }
    ...
    public LoadingPager.LoadedResult initData(LoadingPager loadingPager) {
        ...
        if (mStoryBooksPresenter == null) {
            mStoryBooksPresenter = new StoryBooksPresenter(getContext(), this, "EnglishEnlightenment");
        }
        try {
            mAlbums = mStoryBooksPresenter.loadData(mPage, "839");
    ...
    public View initSuccessView() {
        try {
            ...
            mTotalCount = (int) SharedPreferencesUtils.getParam(MyApplication.sInstance,
                    "EnglishEnlightenment_totalCount", 0);
            initListener();
            mPage++;

            if (mAlbums == null) {
                mAlbums = mStoryBooksPresenter.getResult();
            }
    ...
    public void onSuccess(List<Album> alba, int totalCount) {
        ...
        SharedPreferencesUtils.setParam(MyApplication.sInstance, "EnglishEnlightenment_totalCount", mTotalCount);
        if (mAlbums == null) {
            //去更新fragmen UI
            mAlbums = alba;
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        if (scrollState == SCROLL_STATE_IDLE) {
            ...
            if (view.getLastVisiblePosition() > count && (mAlbums == null
                ...
                mStoryBooksPresenter.loadDataNet(mPage, "839");
    ...
    public void onResume() {
        ...
        MobclickAgent.onPageStart("EnglishEnlightenmentFramgent"); //统计页面，"MainScreen"为页面名称，可自定义
    }

    public void onPause() {
        super.onPause();
        MobclickAgent.onPause(getActivity());
        MobclickAgent.onPageEnd("EnglishEnlightenmentFramgent");
    }
}
