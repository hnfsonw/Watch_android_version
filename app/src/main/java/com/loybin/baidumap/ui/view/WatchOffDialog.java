...
public class WatchOffDialog extends AlertDialog {
    ...
    public WatchOffDialog(Context context, BaseActivity settingActivity) {
    ...
    public void initTitle(String title, String body, String cancel, String determine) {
