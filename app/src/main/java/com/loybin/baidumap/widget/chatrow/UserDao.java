...
public class UserDao {
    ...
    public static final String COLUMN_NAME_ID = "mUsername";
    public static final String COLUMN_NAME_NICK = "mNick";
    ...
    public static final String ROBOT_COLUMN_NAME_ID = "mUsername";
    public static final String ROBOT_COLUMN_NAME_NICK = "mNick";
