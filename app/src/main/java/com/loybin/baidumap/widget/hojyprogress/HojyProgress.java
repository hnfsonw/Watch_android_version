...
public class HojyProgress {
    ...
    public HojyProgress(Context context, DialogInterface.OnKeyListener listener) {
        mContext = context;
    ...
    public static HojyProgress create(Context context, DialogInterface.OnKeyListener mOnKeyListener) {
        return new HojyProgress(context, mOnKeyListener);
    }
