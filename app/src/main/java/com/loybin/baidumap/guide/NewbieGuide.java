...
import com.loybin.baidumap.util.AnimationUtils;
...
import static com.loybin.baidumap.util.AnimationUtils.AnimationState.STATE_HIDDEN;
import static com.loybin.baidumap.util.AnimationUtils.AnimationState.STATE_SHOW;
...
//        container.addView(generateKnowTv("我知道啦"), lp);
    ...
    public void show() {
        LogUtils.e("DevicesHomeActivitys","show~~");
        ...
        AnimationUtils.showAndHiddenAnimation(mGuideView, STATE_SHOW, 800);
        LogUtils.e("DevicesHomeActivity","mOnGuideChangedListener " + mOnGuideChangedListener);
        if(mOnGuideChangedListener != null){
            mOnGuideChangedListener.onShowed();
            LogUtils.d("DevicesHomeActivitys","onShowed触发");
        }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()){
                    case MotionEvent.ACTION_DOWN:
                        LogUtils.e("DevicesHomeActivitys","remove触发");
                        remove();
                }
                return false;
            }
    ...
    public void remove() {
        LogUtils.e("DevicesHomeActivitys","remove~~");
        LogUtils.e("DevicesHomeActivitys","mOnGuideChangedListener~~" + mOnGuideChangedListener);

        if (remove != 3) {
            AnimationUtils.showAndHiddenAnimation(mGuideView, STATE_HIDDEN, 200);
        }else {
            AnimationUtils.showAndHiddenAnimation(mGuideView, STATE_HIDDEN, 1);
        }
...
//        }
        ...
        if(mOnGuideChangedListener != null) {
            LogUtils.e("DevicesHomeActivitys","mOnGuideChangedListener != null");
